...
#sudo apt install -y kubelet=1.26.0-00 kubeadm=1.26.0-00 kubectl=1.26.0-00 docker.io
#sudo apt-mark hold kubelet=1.26.0-00 kubeadm=1.26.0-00 kubectl=1.26.0-00 docker.io
